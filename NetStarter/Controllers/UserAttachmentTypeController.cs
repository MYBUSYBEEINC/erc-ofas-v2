...
namespace NetStarter.Controllers
{
    ...
    public class UserAttachmentTypeController : Controller
    {
        ...
        public ActionResult GetPartialViewUserAttachmentType()
        {
            UserAttachmentTypeListing userAttachmentTypeListing = new UserAttachmentTypeListing();
            userAttachmentTypeListing.Listing = ReadUserAttachmentTypes();
            return PartialView("~/Views/UserAttachmentType/_MainList.cshtml", userAttachmentTypeListing);
        }

        public List<GlobalOptionSetViewModel> ReadUserAttachmentTypes()
        {
